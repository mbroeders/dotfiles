...
I use the excellent [[https://github.com/qutebrowser/qutebrowser][qutebrowser]] as browser so let's make sure it's used as the standard webbrowser to open links.
